...
def chargen(splat_id: str, mode: str = "full", preset: dict | None = None):
    ...
    while True:
        ...
        if result is None or result.get("action") == "cancel":
            ...
            # Save step data (screens return flat dicts with "action" key removed)
            # e.g., identity screen returns {"action": "next", "name": "...", "tradition": "..."}
            # We strip "action" and save the rest directly as step data.
